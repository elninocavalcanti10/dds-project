  ...
  <div class="row">
    <div class="col-md-12 d-flex justify-content-center">
      <div class="header d-flex justify-content-center">
        ...
        <h1 class="achados-perdidos-title">GERENCIA DDS</h1>
      </div>  
    </div>
  </div>
                        ...
                        '<div class="form-row">'+
                          '<div class="form-group col-md-12">'+
                            '<p style="margin-top:20px;">'+
                              'De acordo com a sua estimativa informe a data prevista para a conclusão desta Etapa:'+
                            '</>'+
                          '</div>'+
                        '</div>'+
                        '<div class="form-row">'+
                          '<div class="form-group col-md-10">'+
                            '<label for="Data Prevista">'+
                              'Data:'+
                            '</label>'+
